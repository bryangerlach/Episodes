...
from .views import (home, add_search, add ,single_show, episode_swt, season_swt, search, update_show, update_show_rating, recommended, update_all_continuing, delete_show, mark_all_unwatched, mark_all_watched)
urlpatterns = [
